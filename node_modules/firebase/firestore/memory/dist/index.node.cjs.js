...
var E$1 = {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            if (t.R !== e) throw new T$1(E$1.ABORTED, "getToken aborted due to token change.");
            return n ? (Ve("string" == typeof n.accessToken), new A$1(n.accessToken, t.currentUser)) : null;
    ...
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new T$1(E$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new T$1(E$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new T$1(E$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new T$1(E$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    ...
    n.G = function(t) {
        ...
        // sequences (e.g. __id123__) and just passes them through raw (they exist
        // for legacy reasons and should not be used frequently).
        if (t.indexOf("//") >= 0) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid path (" + t + "). Paths must not contain // in them.");
...
var L$1 = /^[_a-zA-Z][_a-zA-Z0-9]*$/, M$1 = /** @class */ function(e) {
    ...
    n.J = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new T$1(E$1.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new T$1(E$1.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new T$1(E$1.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n;
}(k$1);
...
e) {
    ...
    return __extends(n, e), n.prototype.at = function(t, e) {
        if (this.Et(t), Ve(null != e.transformResults), !this.Rt.wt(t)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
    ...
    return __extends(n, e), n.prototype.at = function(t, e) {
        ...
        return this.Et(t), this.Rt.wt(t) ? new Dt(this.key, V$1.min()) : t;
    }, n.prototype.Pt = function(t) {
        return null;
    }, n.prototype.isEqual = function(t) {
...
var At, It, Nt = function(t, e) {
     ...
     */    return __extends(n, e), n.create = function(t, e, r) {
        ...
        if (nt(r)) {
            if ("==" /* EQUAL */ !== e) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if (rt(r)) {
            if ("==" /* EQUAL */ !== e) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new Ut(t, r) : "in" /* IN */ === e ? new Ot(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new qt(t, r) : new n(t, e, r);
    ...
    return t.prototype.compare = function(t, e) {
        var n = this.de ? U$1.N(t.key, e.key) : function(t, e, n) {
            ...
            return null !== r && null !== i ? J$1(r, i) : Re();
        }(this.field, t, e);
        switch (this.dir) {
          case "asc" /* ASCENDING */ :
            return n;
 ...
 *     Code.UNKNOWN.
 */ (It = At || (At = {}))[It.OK = 0] = "OK", It[It.CANCELLED = 1] = "CANCELLED", 
 ...
 */ var oe = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, he.fs(e, n)), new t(V$1.min(), r, ie(), Yt(), ne());
    }, t;
}(), he = /** @class */ function() {
    function t(
    /**
 ...
 */ var me = {
    ...
    t.prototype.ci = function(t) {
        ...
        // in the local target cache.
                return 4 === e.length ? S$1.H : this.Ti(e);
        ...
        return Ve(t.length > 4 && "documents" === t.get(4)), t.L(5);
    }, 
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.Ii = function(t, e) {
        ...
        if ("targetChange" in t) {
            ...
            var T = t.filter;
            T.targetId;
            var A = T.count || 0, I = new xt(A), N = T.targetId;
            e = new fe(N, I);
        }
        return e;
        ...
        if (0 !== t.length) {
            var n = t.map((function(t) {
                return t instanceof St ? e.Yi(t) : Re();
            }));
...
var Be = function() {
    ...
    function t(t, e, n, r, i) {
        this.Tr = t, this.ir = e, this.wr = n, this.op = r, this.Er = i, this.mr = new Be, 
    ...
    t.prototype.cancel = function(t) {
        null !== this.Rr && (this.clearTimeout(), this.mr.reject(new T$1(E$1.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function t() {
        ...
        this.Dr = new ze(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    t.prototype.Mr = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.kr(), this.gr ? [ 3 /*break*/ , 2 ] : (this.gr = !0, (e = Ee.nt().window) && e.removeEventListener("visibilitychange", this.Fr), 
                    [ 4 /*yield*/ , this.qr(t) ]);
    ...
    t.prototype.xr = function(t) {
                ...
                return __awaiter(r, void 0, void 0, (function() {
                    ...
                    return __generator(this, (function(n) {
                        switch (n.label) {
                          ...
                          case 1:
                            return n.sent(), i.resolve(), this.Dr.reset(), [ 3 /*break*/ , 3 ];
        ...
        var e = this, n = this.pr.then((function() {
            return e.Sr = !0, t().catch((function(t) {
                ...
                throw e.vr = t, e.Sr = !1, _e("INTERNAL UNHANDLED ERROR: ", t.stack || t.message || ""), 
                t;
            })).then((function(t) {
                return e.Sr = !1, t;
            }));
    ...
    t.prototype.dr = function(t, e, n) {
        ...
        var i = Qe.Ir(this, t, e, n, (function(t) {
            return r.Br(t);
        }));
 ...
 */ Je.Jr = -1, Je.Zr = 1048576, Je.th = 41943040, Je.Yr = 10, Je.Xr = 1e3, Je.eh = new Je(Je.th, Je.Yr, Je.Xr), 
Je.DISABLED = new Je(Je.Jr, 0, 0);
...
var He = /** @class */ function() {
    ...
    return t.prototype.hh = function(t, e) {
        return this.rh.add(e), Fe.resolve();
    }, t.prototype.jn = function(t, e) {
        return Fe.resolve(this.rh.getEntries(e));
    }, t;
}(), Ze = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this.lh = V$1.min(), this.Dn = t._h(n), this.fh = t.dh(), this.Th = t.wh(), this.Eh = new xe(this.fh, this.Dn, this.persistence.mh()), 
        this.oh.Ih(this.Eh)
        ...
        return this.persistence.runTransaction("Locally write mutations", "readwrite", (function(o) {
            return n.Eh.qn(o, i).next((function(i) {
                ...
                var s = [], u = 0, a = t; u < a.length; u++) {
                    ...
                    // exists=true
                    s.push(new vt(h.key, c, Tt(c.proto.mapValue), pt.exists(!0)));
                }
    ...
    t.Wh = function(t, e, n) {
        ...
        return Ve(e.resumeToken.rt() > 0), 0 === t.resumeToken.rt() || (e.we.C() - t.we.C() >= this.Xh || n.Ts.size + n.ws.size + n.Es.size > 0);
    ...
    t.prototype.Jh = function(t) {
        ...
        return this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(n) {
            return Fe.forEach(t, (function(t) {
                return Fe.forEach(t.Kn, (function(r) {
                    return e.persistence.zh.Zh(n, t.targetId, r);
                })).next((function() {
                    return Fe.forEach(t.zn, (function(r) {
    ...
    t.prototype.no = function(t) {
        ...
        return this.persistence.runTransaction("Allocate target", "readwrite", (function(n) {
            ...
            return e.Th.ro(n, t).next((function(i) {
                ...
                r = i, Fe.resolve(r)) : e.Th.ho(n).next((function(i) {
                    return r = new Ft(t, i, 0 /* Listen */ , n.Qh), e.Th.oo(n, r).next((function() {
                        return r;
                    }));
                }));
            }));
    ...
    t.prototype.ro = function(t, e) {
        var n = this.uh.get(e);
        return void 0 !== n ? Fe.resolve(this.ah.get(n)) : this.Th.ro(t, e);
    }, 
    /**
    ...
    t.prototype.uo = function(t, e) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.ro(o, t.ee()).next((function(t) {
                ...
                return n.oh.Bn(o, t, e ? r : V$1.min(), e ? i : ne());
            })).next((function(t) {
                return {
                    documents: t,
                    lo: i
...
var $e = /** @class */ function() {
    function t() {
        ...
        this.do = new Wt(tn.To), 
        // A set of outstanding references to a document sorted by target id.
        this.wo = new Wt(tn.Eo)
    ...
    t.prototype.Ao = function(t) {
        var e = this, n = U$1.EMPTY, r = new tn(n, t), i = new tn(n, t + 1), o = [];
        ...
        var e = U$1.EMPTY, n = new tn(e, t), r = new tn(e, t + 1), i = ne();
        return this.wo.Ge([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.po = function(t) {
        var e = new tn(t, 0), n = this.do.Ke(e);
 ...
 */
function en(t, e) {
    if (0 !== e.length) throw new T$1(E$1.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + wn(e.length, "argument") + ".");
}
 ...
 */ function nn(t, e, n) {
    if (e.length !== n) throw new T$1(E$1.INVALID_ARGUMENT, "Function " + t + "() requires " + wn(n, "argument") + ", but was called with " + wn(e.length, "argument") + ".");
}
 ...
 */ function rn(t, e, n) {
    if (e.length < n) throw new T$1(E$1.INVALID_ARGUMENT, "Function " + t + "() requires at least " + wn(n, "argument") + ", but was called with " + wn(e.length, "argument") + ".");
}
 ...
 */ function on(t, e, n, r) {
    if (e.length < n || e.length > r) throw new T$1(E$1.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + wn(e.length, "argument") + ".");
}
...
function cn(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var h = pn(r);
        throw new T$1(E$1.INVALID_ARGUMENT, "Invalid value " + h + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
...
/** Helper to validate the type of a provided input. */ function fn(t, e, n, r) {
    if (!("object" === e ? ln(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = pn(r);
        throw new T$1(E$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + n + " to be of type " + e + ", but it was: " + i);
    }
}
...
function dn(t, e, n) {
    if (void 0 === n) throw new T$1(E$1.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + gn(e) + " argument, but it was undefined.");
}
 ...
 */ function yn(t, e, n) {
    q$1(e, (function(e, r) {
        if (n.indexOf(e) < 0) throw new T$1(E$1.INVALID_ARGUMENT, "Unknown option '" + e + "' passed to function " + t + "(). Available options: " + n.join(", "));
    }));
}
 ...
 */ function vn(t, e, n, r) {
    var i = pn(r);
    return new T$1(E$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + gn(n) + " argument to be a " + e + ", but it was: " + i);
}

function mn(t, e, n) {
    if (n <= 0) throw new T$1(E$1.INVALID_ARGUMENT, 'Function "' + t + '()" requires its ' + gn(e) + " argument to be a positive number, but it was: " + n + ".");
}
...
/** Helper function to assert Uint8Array is available at runtime. */ function bn() {
    if ("undefined" == typeof Uint8Array) throw new T$1(E$1.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function En() {
    if (!Ee.nt().bo) throw new T$1(E$1.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var Tn = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        ...
        try {
            ...
            throw new T$1(E$1.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + e);
        }
    }, t.fromUint8Array = function(e) {
        ...
        return nn("Blob.toBase64", arguments, 0), En(), this.vo.toBase64();
    }, t.prototype.toUint8Array = function() {
        return nn("Blob.toUint8Array", arguments, 0), bn(), this.vo.toUint8Array();
    }, t.prototype.toString = function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        !function(t, e, n, r) {
            if (!(e instanceof Array) || e.length < 1) throw new T$1(E$1.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + wn(1, "element") + ".");
        }(0, t);
        for (var n = 0; n < t.length; ++n) if (sn("FieldPath", "string", n, t[n]), 0 === t[n].length) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.So = new M$1(t);
    }
 ...
 * effect is the same.
 */
An.Co = new An(M$1.X().j());

/**
 * Matches any characters in a field path string that are reserved.
 */
var In = new RegExp("[~\\*/\\[\\]]"), Nn = function(t) {
    this.Do = t;
}, _n = /** @class */ function(e) {
    function n() {
    ...
    return __extends(n, e), n.prototype.Ci = function(t) {
        var e = new qn({
            Fo: 3 /* Argument */ ,
            methodName: this.Do
        }, t.ii, t.serializer), n = Cn(this.ko, e), r = new at(t.serializer, n);
        return new ft(t.path, r);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(Nn), Sn = /** @class */ function() {
    function t(t, e) {
        if (nn("GeoPoint", arguments, 2), sn("GeoPoint", "number", 1, t), sn("GeoPoint", "number", 2, e), 
        !isFinite(t) || t < -90 || t > 90) throw new T$1(E$1.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new T$1(E$1.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.Oo = t, this.qo = e;
    }
...
/** A "context" object passed around while parsing user data. */ var qn = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Bo = function(e) {
        ...
        return new T$1(E$1.INVALID_ARGUMENT, "Function " + this.settings.methodName + "() called with invalid data. " + t + e);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (On(this.Fo) && Ln.test(t)) throw this.No('Document fields cannot begin and end with "__"');
    }, t;
}(), Pn = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.Ho = function(t, e) {
        ...
        jn("Data must be an object, but it was:", n, e);
        var r = Fn(e, n);
        return new Mn(new bt(r), 
    ...
    /** Parse document data from a set() call with '{merge:true}'. */ t.prototype.zo = function(t, e, n) {
        ...
        jn("Data must be an object, but it was:", r, e);
        var i, o, s = Fn(e, r);
        if (n) {
            for (var u = [], a = 0, h = n; a < h.length; a++) {
                var c = h[a], f = void 0;
                if (c instanceof An) f = c.So; else {
                    if ("string" != typeof c) throw Re();
                    f = Bn(t, c);
                }
                if (!r.contains(f)) throw new T$1(E$1.INVALID_ARGUMENT, "Field '" + f + "' is specified in your field mask but missing from your input data.");
                zn(u, f) || u.push(f);
            }
    ...
    /** Parse update data from an update() call. */ t.prototype.Yo = function(t, e) {
        ...
        var o = new ct(r);
        return new Un(i.gt(), o, n.fieldTransforms);
    }, 
    /** Parse update data from a list of field/value arguments. */ t.prototype.Xo = function(t, e, n, r) {
        var i = this.Ko(1 /* Update */ , t), o = [ Gn(t, e) ], s = [ n ];
        if (r.length % 2 != 0) throw new T$1(E$1.INVALID_ARGUMENT, "Function " + t + "() needs to be called with an even number of arguments that alternate between field names and values.");
        ...
        var y = new ct(a);
        return new Un(h.gt(), y, i.fieldTransforms);
    }, 
    ...
    t.prototype.Jo = function(t, e, n) {
        return void 0 === n && (n = !1), Cn(e, this.Ko(n ? 4 /* ArrayArgument */ : 3 /* Argument */ , t));
    }, t;
}();
 ...
 */
function Cn(t, e) {
    if (xn(t)) return jn("Unsupported field value:", e, t), Fn(t, e);
    if (t instanceof Nn) 
    ...
    return function(t, e) {
        ...
        if (!On(e.Fo)) throw e.No(t.Do + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        throw e.No("Unsupported field value: " + pn(t));
    }(t, e);
}
...
function xn(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof R$1 || t instanceof Sn || t instanceof Tn || t instanceof Dr || t instanceof Nn);
}
 ...
 */ function Gn(t, e) {
    if (e instanceof An) return e.So;
    if ("string" == typeof e) return Bn(t, e);
    throw new T$1(E$1.INVALID_ARGUMENT, "Function " + t + "() called with invalid data. Field path arguments must be of type string or FieldPath.");
}
 ...
 */ function Bn(t, e) {
    try {
        return function(t) {
            if (t.search(In) >= 0) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (An.bind.apply(An, __spreadArrays([ void 0 ], t.split("."))));
            } catch (e) {
                throw new T$1(E$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(e).So;
    } catch (e) {
        var n = (i = e) instanceof Error ? i.message : i.toString();
        throw new T$1(E$1.INVALID_ARGUMENT, "Function " + t + "() called with invalid data. " + n);
    }
    /**
 ...
 */ var Qn = /** @class */ function() {
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.na = 0, this.ra = null, this.stream = null, this.Dr = new ze(t, e)
        /**
    ...
    t.prototype.da = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new T$1(E$1.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.ma(e);
            }));
        }));
    ...
    t.prototype.wa = function(t) {
        ...
        return function(n) {
            e.sr.Vr((function() {
                return e.na === t ? n() : (Ne("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    n.prototype.start = function() {
        ...
        Ve(!!t.streamToken), this.lastStreamToken = this.serializer.ci(t.streamToken), this.ya) {
        ...
        // The first response is always the handshake response
                return Ve(!t.writeResults || 0 === t.writeResults.length), this.ya = !0, 
        this.listener.Sa();
    }, 
    /**
    ...
    return t.prototype.Ma = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.xa(), this.mutations.length > 0) throw new T$1(E$1.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof Dt || t instanceof _t ? i.Ba(t) : Re();
                    })), r) ];
                }
            }));
        }));
        ...
        if (null !== n) {
            ...
            throw new T$1(E$1.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.Ua = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new T$1(E$1.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    t.prototype.set = function(t) {
        ...
        this.Ga ? (_e(e), this.Ga = !1) : Ne("OnlineStateTracker", e);
    ...
    r, i, o, s) {
            ...
            i.Vr((function() {
                return __awaiter(u, void 0, void 0, (function() {
                    return __generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.ru() ? (Ne("RemoteStore", "Restarting streams for network reachability change."), 
        ...
        this.au = function(t, e, n) {
            var r = ke(t);
            return new Wn(e, r.sa, r.credentials, r.serializer, n);
        }(this.$a, i, {
            ...
            var r = ke(t);
            return new Jn(e, r.sa, r.credentials, r.serializer, n);
        }(this.$a, i, {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), this.Za.length > 0 && (Ne("RemoteStore", "Stopping write stream with " + this.Za.length + " pending writes"), 
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 11:
                    return Ne("RemoteStore", "Failed to raise snapshot:", o = n.sent()), [ 4 /*yield*/ , this.vu(o) ];
                            ...
                            return __generator(this, (function(t) {
                                switch (t.label) {
                                  case 0:
                                    ...
                                    return Ne("RemoteStore", "Retrying IndexedDB access"), [ 4 /*yield*/ , this.Ja.Mh() ];
    ...
    t.prototype.Fu = function(t) {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(e) {
                ...
                return jt(t.code) ? [ 2 /*return*/ , (Ne("RemoteStore", "RemoteStore error before completed handshake; resetting stream token: ", this._u.lastStreamToken), 
                this._u.lastStreamToken = C$1.ht, this.Ja.qh(C$1.ht).catch(Ke)) ] : [ 2 /*return*/ ];
            }));
        }));
            ...
            return __generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    ...
                    Ne("RemoteStore", "RemoteStore restarting streams for new credential"), [ 4 /*yield*/ , this.hu() ]) : [ 3 /*break*/ , 2 ];
    ...
    function t() {
        this.Gu = new Kn, this.Hu = {}, this.gu = null, this.Qa = null, this.Xn = null;
    }
    return t.prototype.Ku = function(t) {
        ...
        return this.Gu = new Kn, Promise.resolve();
    ...
    function t(t, e, n, r) {
        this.Tr = t, this.Ac = e, this.updateFunction = n, this.mr = r, this.Pc = 5, this.Dr = new ze(this.Tr, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.Vc = function() {
        ...
        try {
            ...
            return !F$1(e) && e.catch && e.then ? e : (this.mr.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
n) {
    ...
    n, r, i) {
        ...
        /**
             ...
             */
        this.kc = new Map, this.Oc = new $e, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.qc = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Mc = new Map, this.xc = He.nh(), this.onlineState = "Unknown" /* Unknown */;
    }
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return e = n.sent(), o = new nr(t, e.lo), s = o.uc(e.documents), u = he.fs(r, i && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.fc(s, 
                    /* updateLimboDocuments= */ this.Bc, u), this.Wc(r, a.wc), h = new ir(t, r, o), 
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.Ja.yh(t) ];
                  ...
                  case 3:
                    ...
                    void r.reject(new T$1(E$1.UNAVAILABLE, "Failed to persist write: " + i))) ];
                    throw i;

                  case 4:
                    return this.Sc.Ku(e.batchId), this.Gc(e.batchId, r), [ 4 /*yield*/ , this.Hc(e.bh) ];
                ...
                switch (n.label) {
                  ...
                  case 2:
                    ...
                    t.as.forEach((function(t, e) {
                        ...
                        Ve(t.Ts.size + t.ws.size + t.Es.size <= 1), t.Ts.size > 0 ? n.vc = !0 : t.ws.size > 0 ? Ve(n.vc) : t.Es.size > 0 && (Ve(n.vc), 
                        n.vc = !1));
                    })), [ 4 /*yield*/ , this.Hc(e, t) ];
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.Sc.Xu(t, "rejected", r), e = this.kc.get(t), (i = e && e.key) ? (
                    // Since this query failed, we won't want to manually unlisten to it.
                    // So go ahead and remove it from bookkeeping.
                    this.Lc = this.Lc.remove(i), this.kc.delete(t), this.zc(), o = (o = new Bt(U$1.N)).Re(i, new Dt(i, V$1.min())), 
                    s = ne().add(i), u = new ae(V$1.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new Wt(Le), o, s), [ 2 /*return*/ , this.xh(u) ]) : [ 4 /*yield*/ , this.Ja.ao(t, /* keepPersistedTargetData */ !1).then((function() {
                        return a.jc(t, r);
                    })).catch(Ke) ];
    ...
    t.prototype.Jc = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Ac.ru() || Ne("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    [ 4 /*yield*/ , this.Ja.kh() ];

                  case 1:
                    return -1 === (e = n.sent()) ? [ 2 /*return*/ , void t.resolve() ] : ((r = this.Mc.get(e) || []).push(t), 
                    this.Mc.set(e, r), [ 2 /*return*/ ]);
                }
            }));
        }));
    }, 
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.Zc = function(t) {
        this.Mc.forEach((function(e) {
            e.forEach((function(e) {
                e.reject(new T$1(E$1.CANCELLED, t));
            }));
        })), this.Mc.clear();
    ...
    t.prototype.Yc = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof tr ? (this.Oc.Zh(i.key, t), this.sl(i)) : i instanceof er ? (Ne("SyncEngine", "Document no longer in limbo: " + i.key), 
        ...
        var e = t.key;
        this.Lc.get(e) || (Ne("SyncEngine", "New document in limbo: " + e), this.$c.push(e), 
        this.zc());
    }, 
    /**
    ...
    t.prototype.zc = function() {
        for (;this.$c.length > 0 && this.Lc.size < this.Cc; ) {
            ...
            this.kc.set(e, new or(t)), this.Lc = this.Lc.Re(t, e), this.Ac.listen(new Ft(kt.Wt(t.path).ee(), e, 2 /* LimboResolution */ , Ge.er));
        }
    }, 
    // Visible for testing
    ...
    function t(t) {
        this.gu = t, this.ol = new qe((function(t) {
            return t.canonicalId();
    ...
    return t.prototype.listen = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (e = t.query, r = !1, (i = this.ol.get(e)) || (r = !0, i = new ur), !r) return [ 3 /*break*/ , 4 ];
                    n.label = 1;
                  ...
                  case 3:
                    ...
                    return [ 2 /*return*/ , void t.onError(new T$1(E$1.UNAVAILABLE, u)) ];
    ...
    return t.prototype.Ih = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.te() || n.isEqual(V$1.min()) ? this.Al(t, e) : this.Rl.qn(t, r).next((function(o) {
            var u = i.Pl(e, o);
            return (e.oe() || e.ae()) && i._c(e.xt, u, r, n) ? i.Al(t, e) : (Ae() <= LogLevel.DEBUG && Ne("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), e.toString()), 
    ...
    t.prototype._c = function(t, e, n, r) {
        ...
        return Ae() <= LogLevel.DEBUG && Ne("IndexFreeQueryEngine", "Using full collection scan to execute query: %s", e.toString()), 
        this.Rl.Bn(t, e, V$1.min());
    }, t;
}(), fr = /** @class */ function() {
    function t(t, e) {
        this.Fn = t, this.zh = e, 
    ...
    return t.prototype.yl = function(t) {
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.pl = this.pl.add(new tn(a.key, i)), this.Fn.hh(t, a.key.path.k());
        }
        return Fe.resolve(o);
        ...
        // because it precedes all other segments in an ordered traversal.
                U$1.et(i) || (i = i.child(""));
        var o = new tn(new U$1(i), 0), s = new Wt(Le);
        ...
        var n = this;
        Ve(0 === this.gl(e.batchId, "removed")), this.Dn.shift();
        var r = this.pl;
        ...
        var n = new tn(e, 0), r = this.pl.Ke(n);
...
var pr = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.jl = new $e, this.targetCount = 0, this.Gl = He.ih();
    }
    return t.prototype.js = function(t, e) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.Gl = new He(e), this.highestTargetId = e), t.sequenceNumber > this.Wl && (this.Wl = t.sequenceNumber);
    ...
    function t(t) {
        ...
        this.Th = new pr(this), this.Fn = new Ye, this.Cn = new lr(this.Fn, (function(t) {
            return e.zh.s_(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.Zl[t.s()];
        return e || (e = new fr(this.Fn, this.zh), this.Zl[t.s()] = e), e;
    ...
    return t.prototype.initialize = function(t) {
        ...
        return new ar(this.gu);
    }, t.prototype.I_ = function(t) {
        return null;
    }, t.prototype.R_ = function(t) {
        return new Xe(this.persistence, new cr, t.y_);
        ...
        return new sr(this.Ja, this.Ac, this.Sc, t.y_, t.Cc);
    }, t.prototype.clearPersistence = function(t) {
        throw new T$1(E$1.FAILED_PRECONDITION, "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.");
    }, t;
}(), gr = /** @class */ function() {
    function t(t, e, n, 
    /**
     ...
     */
    r) {
        this.platform = t, this.b_ = e, this.credentials = n, this.Tr = r, this.clientId = Se.cn()
        /**
    ...
    return t.prototype.start = function(t, e) {
        ...
        return this.credentials._((function(s) {
            if (!o) return o = !0, Ne("FirestoreClient", "Initializing. user=", s.uid), n.S_(t, e, s, i).then(r.resolve, r.reject);
            n.Tr.Vr((function() {
                return n.Bu(s);
            }));
        })), 
    ...
    t.prototype.v_ = function() {
        if (this.Tr.$r) throw new T$1(E$1.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.Bu = function(t) {
        return this.Tr.Ur(), Ne("FirestoreClient", "Credential Changed. Current user: " + t.uid), 
        this.gu.Bu(t);
    }, 
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        return this.v_(), this.Tr.enqueue((function() {
            ...
            throw new T$1(E$1.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)");
        }));
            ...
            return __awaiter(r, void 0, void 0, (function() {
                ...
                return __generator(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 1:
                        return e = n.sent(), r = new nr(t, e.lo), i = r.uc(e.documents), [ 2 /*return*/ , r.fc(i, 
...
var Er = /** @class */ function() {
    ...
    return t.prototype.U_ = function(t) {
        switch (z(t)) {
          ...
          case 6 /* BlobValue */ :
            return new Tn(K$1(t.bytesValue));
        ...
        return new Sn(X$1(t.latitude), X$1(t.longitude));
    }, t.prototype.H_ = function(t) {
        var e = this;
        ...
        var e = Z$1(t), n = new R$1(e.seconds, e.nanos);
        return this.timestampsInSnapshots ? n : n.toDate();
    }, t.prototype.j_ = function(t) {
        var e = S$1.G(t);
        Ve(be(e));
        var n = new Oe(e.get(1), e.get(3)), r = new U$1(e.L(5));
        ...
        new Dr(r, this.firestore, this.converter);
    }, t;
}(), Tr = Je.Jr, Ar = /** @class */ function() {
    function t(t) {
        var e, n;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new T$1(E$1.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
        ...
        hn("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Je.th; else {
            if (t.cacheSizeBytes !== Tr && t.cacheSizeBytes < Je.Zr) throw new T$1(E$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Je.Zr);
    ...
    function t(r, i, o) {
        var s = this;
        if (void 0 === o && (o = new mr), this.z_ = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.Y_ = new We, this.INTERNAL = {
            delete: function() {
            ...
            var u = r;
            this.z_ = u, this.Zo = t.Z_(u), this.tf = u.name, this.ef = new N$1(i);
        } else {
            var a = r;
            if (!a.projectId) throw new T$1(E$1.INVALID_ARGUMENT, "Must provide projectId");
            this.Zo = new Oe(a.projectId, a.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.tf = "[DEFAULT]", this.ef = new I$1;
        }
        this.sf = o, this.if = new Ar({}), this.nf = new Pn(this.Zo);
    }
    return t.prototype.settings = function(t) {
        nn("Firestore.settings", arguments, 1), sn("Firestore.settings", "object", 1, t);
        var e = new Ar(t);
        if (this.J_ && !this.if.isEqual(e)) throw new T$1(E$1.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        this.if = e, void 0 !== e.credentials && (this.ef = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new T$1(E$1.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(e.credentials));
    }, t.prototype.enableNetwork = function() {
        ...
        var e, n;
        if (this.J_) throw new T$1(E$1.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1;
        ...
        return __awaiter(this, void 0, void 0, (function() {
            var t, r = this;
            return __generator(this, (function(i) {
                if (void 0 !== this.J_ && !this.J_.k_) throw new T$1(E$1.FAILED_PRECONDITION, "Persistence cannot be cleared after this Firestore instance is initialized.");
                return t = new Be, [ 2 /*return*/ , (this.Y_.Lr((function() {
                    return __awaiter(r, void 0, void 0, (function() {
                        var e, r;
                        return __generator(this, (function(n) {
                            switch (n.label) {
        ...
        if (this.X_(), br(t)) return this.cf(t);
        ...
        var n = this.af();
        return this.J_ = new gr(Ee.nt(), n, this.ef, this.Y_), this.J_.start(t, e);
    }, t.Z_ = function(t) {
        if (e = t.options, !Object.prototype.hasOwnProperty.call(e, "projectId")) throw new T$1(E$1.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
 ...
 */        if (!n || "string" != typeof n) throw new T$1(E$1.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        return new Oe(n);
    }, Object.defineProperty(t.prototype, "app", {
        get: function() {
            if (!this.z_) throw new T$1(E$1.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.z_;
        },
        enumerable: !0,
        configurable: !0
        ...
        this.X_(), new Mr(S$1.G(t), this);
    }, t.prototype.doc = function(t) {
        return nn("Firestore.doc", arguments, 1), sn("Firestore.doc", "non-empty string", 1, t), 
        this.X_(), Dr.lf(S$1.G(t), this);
    }, t.prototype.collectionGroup = function(t) {
        if (nn("Firestore.collectionGroup", arguments, 1), sn("Firestore.collectionGroup", "non-empty string", 1, t), 
        t.indexOf("/") >= 0) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid collection ID '" + t + "' passed to function Firestore.collectionGroup(). Collection IDs must not contain '/'.");
        return this.X_(), new Sr(new kt(S$1.H, t), this);
        ...
        t) {
          ...
          default:
            throw new T$1(E$1.INVALID_ARGUMENT, "Invalid log level: " + t);
        }
    }, 
    ...
    return t.prototype.get = function(t) {
        ...
        var n = Pr("Transaction.get", t, this.ff);
        return this.df.Ma([ n.ta ]).then((function(t) {
            if (!t || 1 !== t.length) return Re();
            var r = t[0];
            if (r instanceof Dt) return new Vr(e.ff, n.ta, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Tf);
            if (r instanceof _t) return new Vr(e.ff, n.ta, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Tf);
            throw Re();
        }));
        ...
        var r = Pr("Transaction.set", t, this.ff);
        n = Ur("Transaction.set", n);
        var i = Fr(r.Tf, e, "Transaction.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.ff.nf.zo(s, o, n.mergeFields) : this.ff.nf.Ho(s, o);
        ...
        r = Pr("Transaction.update", t, this.ff), i = this.ff.nf.Xo("Transaction.update", e, n, o)) : (nn("Transaction.update", arguments, 2), 
        r = Pr("Transaction.update", t, this.ff), i = this.ff.nf.Yo("Transaction.update", e)), 
        this.df.update(r.ta, i), this;
    }, t.prototype.delete = function(t) {
        nn("Transaction.delete", arguments, 1);
        var e = Pr("Transaction.delete", t, this.ff);
    ...
    return t.prototype.set = function(t, e, n) {
        on("WriteBatch.set", arguments, 2, 3), this.mf();
        var r = Pr("WriteBatch.set", t, this.ff);
        n = Ur("WriteBatch.set", n);
        var i = Fr(r.Tf, e, "WriteBatch.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.ff.nf.zo(s, o, n.mergeFields) : this.ff.nf.Ho(s, o);
        return this.wf = this.wf.concat(u.Mo(r.ta, pt.dt())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.mf(), "string" == typeof e || e instanceof An ? (rn("WriteBatch.update", arguments, 3), 
        r = Pr("WriteBatch.update", t, this.ff), i = this.ff.nf.Xo("WriteBatch.update", e, n, o)) : (nn("WriteBatch.update", arguments, 2), 
        r = Pr("WriteBatch.update", t, this.ff), i = this.ff.nf.Yo("WriteBatch.update", e)), 
        this.wf = this.wf.concat(i.Mo(r.ta, pt.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        nn("WriteBatch.delete", arguments, 1), this.mf();
        var e = Pr("WriteBatch.delete", t, this.ff);
        return this.wf = this.wf.concat(new gt(e.ta, pt.dt())), this;
    }, t.prototype.commit = function() {
        return this.mf(), this.Ef = !0, this.wf.length > 0 ? this.ff.X_().write(this.wf) : Promise.resolve();
    }, t.prototype.mf = function() {
        if (this.Ef) throw new T$1(E$1.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), Dr = /** @class */ function() {
    function t(t, e, n) {
    ...
    return t.lf = function(e, n, r) {
        if (e.length % 2 != 0) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + e.j() + " has " + e.length);
        ...
        get: function() {
            return new Mr(this.ta.path.k(), this.firestore, this.Tf);
        },
        enumerable: !0,
        configurable: !0
        ...
        !t) throw new T$1(E$1.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = S$1.G(t);
        return new Mr(this.ta.path.child(e), this.firestore);
    }, t.prototype.isEqual = function(e) {
        ...
        on("DocumentReference.set", arguments, 1, 2), e = Ur("DocumentReference.set", e);
        var n = Fr(this.Tf, t, "DocumentReference.set"), r = n[0], i = n[1], o = e.merge || e.mergeFields ? this.firestore.nf.zo(i, r, e.mergeFields) : this.firestore.nf.Ho(i, r);
        ...
        n = this.firestore.nf.Xo("DocumentReference.update", t, e, r)) : (nn("DocumentReference.update", arguments, 1), 
        n = this.firestore.nf.Yo("DocumentReference.update", t)), this.J_.write(n.Mo(this.ta, pt.exists(!0)));
    }, t.prototype.delete = function() {
        return nn("DocumentReference.delete", arguments, 0), this.J_.write([ new gt(this.ta, pt.dt()) ]);
        ...
        var i = new wr({
            next: function(t) {
                if (e.next) {
                    ...
                    e.next(new Vr(n.firestore, n.ta, r, t.fromCache, t.hasPendingWrites, n.Tf));
                }
            },
            error: r
        }), o = this.J_.listen(kt.Wt(this.ta.path), i, t);
        return function() {
            i.x_(), n.J_.pu(o);
        };
    }, t.prototype.get = function(t) {
        var e = this;
        return on("DocumentReference.get", arguments, 0, 1), qr("DocumentReference.get", t), 
        new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.X_().O_(e.ta).then((function(t) {
                n(new Vr(e.firestore, e.ta, t, 
                /*fromCache=*/ !0, t instanceof _t && t.At, e.Tf));
            }), r) : e.Rf(n, r, t);
        }));
        ...
        var r = this.If({
            ...
            next: function(i) {
                ...
                e(new T$1(E$1.UNAVAILABLE, "Failed to get document because the client is offline.")) : i.exists && i.metadata.fromCache && n && "server" === n.source ? e(new T$1(E$1.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : t(i);
            },
            error: e
        });
    ...
    return t.prototype.data = function(t) {
        if (on("DocumentSnapshot.data", arguments, 0, 1), t = Or("DocumentSnapshot.data", t), 
        this.Af) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.Tf) {
                var e = new kr(this.ff, this.ta, this.Af, this.Pf, this.Vf);
                return this.Tf.fromFirestore(e, t);
            }
            return new Er(this.ff, this.ff._f(), t.serverTimestamps, 
            /* converter= */ void 0).U_(this.Af.kt());
        }
    }, t.prototype.get = function(t, e) {
        if (on("DocumentSnapshot.get", arguments, 1, 2), e = Or("DocumentSnapshot.get", e), 
        this.Af) {
            var n = this.Af.data().field(Gn("DocumentSnapshot.get", t));
            if (null !== n) return new Er(this.ff, this.ff._f(), e.serverTimestamps, this.Tf).U_(n);
        }
    }, Object.defineProperty(t.prototype, "id", {
        get: function() {
            return this.ta.path.q();
        ...
        get: function() {
            return new Dr(this.ta, this.ff, this.Tf);
        },
        enumerable: !0,
        configurable: !0
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        var i, o = function(t, e, n, r) {
            if (!e.some((function(t) {
                return t === r;
            }))) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid value " + pn(r) + " provided to function Query.where() for its " + gn(2) + " argument. Acceptable values: " + e.join(", "));
            return r;
        ...
        if (s.Y()) {
            if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            if ("in" /* IN */ === o) {
                this.yf(r, o);
        ...
        return this.bf(f), new t(this.pf.Ht(f), this.firestore, this.Tf);
        ...
        void 0 === n || "asc" === n) r = "asc" /* ASCENDING */; else {
            if ("desc" !== n) throw new T$1(E$1.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + n + "', expected 'asc' or 'desc'.");
            r = "desc" /* DESCENDING */;
        }
        if (null !== this.pf.startAt) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.pf.endAt) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
        var i = Gn("Query.orderBy", e), o = new Ct(i, r);
        ...
        mn("Query.limitToLast", 1, e), new t(this.pf.Yt(e), this.firestore, this.Tf);
    ...
    /** Helper function to create a bound from a document or fields */ t.prototype.Sf = function(t, e, n, r) {
        if (dn(t, 1, e), e instanceof Vr) {
            if (n.length > 0) throw new T$1(E$1.INVALID_ARGUMENT, "Too many arguments provided to " + t + "().");
            var i = e;
            if (!i.exists) throw new T$1(E$1.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + t + "().");
    ...
    t.prototype.Cf = function(t, e) {
        ...
        for (var n = [], r = 0, i = this.pf.orderBy; r < i.length; r++) {
            ...
            if (o.field.Y()) n.push($(this.firestore.Zo, t.key)); else {
                ...
                if (j(s)) throw new T$1(E$1.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + o.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === s) {
                    var u = o.field.j();
                    throw new T$1(E$1.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + u + "' (used as the orderBy) does not exist.");
                }
                n.push(s);
            }
        }
    ...
    t.prototype.Df = function(t, e, n) {
        ...
        var r = this.pf.Mt;
        if (e.length > r.length) throw new T$1(E$1.INVALID_ARGUMENT, "Too many arguments provided to " + t + "(). The number of arguments must be less than or equal to the number of Query.orderBy() clauses");
        for (var i = [], o = 0; o < e.length; o++) {
            var s = e[o];
            if (r[o].field.Y()) {
                if ("string" != typeof s) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + t + "(), but got a " + typeof s);
                if (!this.pf.le() && -1 !== s.indexOf("/")) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + t + "() must be a plain document ID, but '" + s + "' contains a slash.");
                var u = this.pf.path.child(S$1.G(s));
                if (!U$1.et(u)) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + t + "() must result in a valid document path, but '" + u + "' is not because it contains an odd number of segments.");
                var a = new U$1(u);
        ...
        var i = new wr({
            next: function(t) {
                e.next && e.next(new Lr(n.firestore, n.pf, t, n.Tf));
            },
            error: r
        ...
        if (t.ae() && 0 === t.Mt.length) throw new T$1(E$1.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
    }, t.prototype.get = function(t) {
        var e = this;
        return on("Query.get", arguments, 0, 1), qr("Query.get", t), this.Ff(this.pf), new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.X_().q_(e.pf).then((function(t) {
                n(new Lr(e.firestore, e.pf, t, e.Tf));
            }), r) : e.Rf(n, r, t);
        }));
    }, t.prototype.Rf = function(t, e, n) {
        var r = this.If({
            ...
            next: function(i) {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                r(), i.metadata.fromCache && n && "server" === n.source ? e(new T$1(E$1.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : t(i);
            },
            error: e
        });
    }, 
    ...
    t.prototype.gf = function(t) {
        if ("string" == typeof t) {
            if ("" === t) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
            if (!this.pf.le() && -1 !== t.indexOf("/")) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + t + "' contains a '/' character.");
            var e = this.pf.path.child(S$1.G(t));
            if (!U$1.et(e)) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + e + "' is not because it has an odd number of segments (" + e.length + ").");
        ...
        throw new T$1(E$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + pn(t) + ".");
    }, 
    /**
    ...
    t.prototype.yf = function(t, e) {
        if (!Array.isArray(t) || 0 === t.length) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
        if (t.length > 10) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
        if (t.indexOf(null) >= 0) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'null' in the value array.");
        if (t.filter((function(t) {
            return Number.isNaN(t);
        })).length > 0) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'NaN' in the value array.");
        ...
        if (t instanceof St) {
            ...
            if (t.ue()) {
                var o = this.pf.jt();
                if (null !== o && !o.isEqual(t.field)) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + o.toString() + "' and '" + t.field.toString() + "'");
                var s = this.pf.Gt();
                ...
                throw u === t.op ? new T$1(E$1.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + t.op.toString() + "' filter.") : new T$1(E$1.INVALID_ARGUMENT, "Invalid query. You cannot use '" + t.op.toString() + "' filters with '" + u.toString() + "' filters.");
            }
        }
        ...
        if (!e.isEqual(t)) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, >, or >=) on field '" + t.toString() + "' and so you must also use '" + t.toString() + "' as your first Query.orderBy(), but your first Query.orderBy() is on field '" + e.toString() + "' instead.");
    }, t;
}(), Lr = /** @class */ function() {
    function t(t, e, n, r) {
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        get: function() {
            return new Sr(this.$f, this.ff, this.Tf);
        },
        enumerable: !0,
        configurable: !0
        ...
        if (e && this.Lf.hs) throw new T$1(E$1.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return new kr(this.ff, t.key, t, this.metadata.fromCache, this.Lf.ns.has(t.key), this.Tf);
    }, t;
}(), Mr = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, kt.Wt(t), n, r) || this).Mf = t, t.length % 2 != 1) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.j() + " has " + t.length);
        return i;
    }
    return __extends(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.M() ? null : new Dr(new U$1(t), this.firestore);
        },
        enumerable: !0,
        configurable: !0
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = Se.cn()), sn("CollectionReference.doc", "non-empty string", 1, t), 
        "" === t) throw new T$1(E$1.INVALID_ARGUMENT, "Document path must be a non-empty string");
        var e = S$1.G(t);
        return Dr.lf(this.pf.path.child(e), this.firestore, this.Tf);
    }, n.prototype.add = function(t) {
        nn("CollectionReference.add", arguments, 1), sn("CollectionReference.add", "object", 1, this.Tf ? this.Tf.toFirestore(t) : t);
        var e = this.doc();
...
function Ur(t, e) {
    ...
    if (yn(t, e, [ "merge", "mergeFields" ]), hn(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new T$1(E$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + pn(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new T$1(E$1.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + pn(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof An;
    })), void 0 !== e.mergeFields && void 0 !== e.merge) throw new T$1(E$1.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}
...
function Pr(t, e, n) {
    if (e instanceof Dr) {
        if (e.firestore !== n) throw new T$1(E$1.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return e;
    }
...
function xr(t, e) {
    function n() {
        ...
        throw e && (t += " ", t += e), new T$1(E$1.INVALID_ARGUMENT, t);
    }
...
var jr = xr(Ir, "Use firebase.firestore() instead."), Gr = xr(Nr, "Use firebase.firestore().runTransaction() instead."), Br = xr(_r, "Use firebase.firestore().batch() instead."), zr = xr(Dr, "Use firebase.firestore().doc() instead."), Qr = xr(Vr), Wr = xr(kr), Jr = xr(Sr), Hr = xr(Lr), Yr = xr(Mr, "Use firebase.firestore().collection() instead."), Zr = xr(/** @class */ function() {
    function t() {}
    return t.delete = function() {
        return en("FieldValue.delete", arguments), new _n;
    }, t.serverTimestamp = function() {
        return en("FieldValue.serverTimestamp", arguments), new Dn;
    }, t.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
                return rn("FieldValue.arrayUnion", arguments, 1), new Rn(t);
    }, t.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
                return rn("FieldValue.arrayRemove", arguments, 1), new Vn(t);
...
}(), "Use FieldValue.<field>() instead."), Xr = xr(Tn, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), Kr = {
    Firestore: jr,
    GeoPoint: Sn,
    Timestamp: R$1,
    Blob: Xr,
     ...
     */    return t.prototype.sd = function(t, e) {
            ...
            u.listenOnce(esm_3.COMPLETE, (function() {
                try {
                    switch (u.getLastErrorCode()) {
                      ...
                      case esm_2.TIMEOUT:
                        Ne("Connection", 'RPC "' + t + '" timed out'), s(new T$1(E$1.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case esm_2.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                s(new T$1(i, r.message));
                            } else s(new T$1(E$1.UNKNOWN, "Server responded with status " + u.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        Ne("Connection", 'RPC "' + t + '" failed'), s(new T$1(E$1.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var o = n.join("");
        Ne("Connection", "Creating WebChannel: " + o + " " + i);
        var s = r.createWebChannel(o, i), p = !1, d = !1, y = new ei({
            Hf: function(t) {
                d ? Ne("Connection", "Not sending because WebChannel is closed:", t) : (p || (Ne("Connection", "Opening WebChannel transport."), 
                s.open(), p = !0), Ne("Connection", "WebChannel sending:", t), s.send(t));
            },
            Kf: function() {
                return s.close();
            }
        ...
        return v(esm_4.EventType.OPEN, (function() {
            d || Ne("Connection", "WebChannel transport opened.");
        })), v(esm_4.EventType.CLOSE, (function() {
            d || (d = !0, Ne("Connection", "WebChannel transport closed"), y.Zf());
        })), v(esm_4.EventType.ERROR, (function(t) {
            d || (d = !0, Ne("Connection", "WebChannel transport errored:", t), y.Zf(new T$1(E$1.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!d) {
                ...
                if (i) {
                    ...
                    d = !0, y.Zf(new T$1(u, a)), s.close();
                } else Ne("Connection", "WebChannel received:", n), y.td(n);
            }
        })), setTimeout((function() {
 ...
 */
    !function(t, e) {
        t.INTERNAL.registerComponent(new Component("firestore", (function(t) {
            return function(t, e) {
                return new Ir(t, e, new mr);
            }(t.getProvider("app").getImmediate(), t.getProvider("auth-internal"));
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, Kr)));
